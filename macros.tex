...
%% configurazioni della semantica <skip, s, flag>
...
%% Luca Parolari
% macro per l:C (sintassi)
\newcommand*{\lab}[2]{#1: #2}
% macro per goto l (sintassi)
\newcommand*{\goto}[1]{\kw{goto}\ #1}
% macro per goto l (flag)
\newcommand*{\fgoto}[1]{\textit{goto}\ #1}
% macro per exec (flag)
\newcommand*{\fexec}{\textit{exec}}
