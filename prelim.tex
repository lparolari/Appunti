...
\summary{(Ogni catena finita ha un elemento massimo.)}
\end{proposizione}
\begin{proof}
...
\begin{proposizione} \summary{(Equivalenza delle definizioni \textup{\ref{def:reticolo1}} e \textup{\ref{def:reticolo2}} di reticolo.)}
